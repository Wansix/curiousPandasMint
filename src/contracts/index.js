...
export const curiousPandaNFTAddress =
  "0xF33E31c6aaAAc80CD1E52adAb579ac61756Bd740";
...
export const getNFTCountsList = async (index, address) => {
  const result = await contract.NFTCountsList(address);
  return result[index];
};

export const checkWhitelist = async (index, address) => {
  if (index === 0) {
    return await contract._whitelistedAddress(address);
  } else if (index === 1) {
    return await contract._whitelistedAddress2(address);
  }
};
